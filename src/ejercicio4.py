...
from validacion import (
    validar_countryCode_registro,
    validar_fecha_registro,
    validar_incertidumbre_registro,
    validar_latitud_registro,
    validar_longitud_registro,
)
...
def inicio_registro(tipo_dataset):
    ...
    if tipo_dataset == "iadiza" or tipo_dataset == "xenocanto":
        ...
        if tipo_dataset == "iadiza":
            ...
            nuevo_registro.update(
                {"vernacularName": "", "mediaType": "", "format": "", "license": ""}
            )
...
def agrupar_validaciones(registro):
    ...
    if "coordinateUncertaintyInMeters" in registro:
        errores.extend(
            validar_incertidumbre_registro(registro["coordinateUncertaintyInMeters"])
        )
...
# ===================== Punto 4G =======================
def agregar_multiples_registros(
    numero_dataset, tipo_dataset, cantidad, carpeta_destino="processed_datasets"
):
    """

from validacion import (validar_latitud_registro, validar_longitud_registro, validar_fecha_registro, validar_countryCode_registro, validar_incertidumbre_registro)
import random
import csv
import os
